...
class NaturgyIncidentClassifier:
    ...
    def _generate_enhanced_description(self, cluster_df: pd.DataFrame, 
        ...
        # Añadir información sobre causas principales si están disponibles
    ...
    def _apply_semantic_rules(self, combined_text: str) -> Optional[Dict[str, Any]]:
        ...
        # 🎯 SISTEMA DEFINITIVO DE CLASIFICACIÓN NATURGY - 20 CATEGORÍAS TÉCNICAS
        keywords = {
            # 1️⃣ Gestión de CUPS
            "gestion_cups": [
                "alta cups", "baja cups", "activar cups", "procesar baja", "procesar activación",
            ...
            "errores_calculo_facturacion": [
                ...
                "error genérico de cálculo", "error genérico del cálculo"
            ],
            ...
            "integraciones_externas": [
                ...
                "integración externa", "interfaz externa"
            ],
        ...
        category_info = {
            ...
            "tarifas_productos": {
                ...
                'descripcion': 'Cambio o corrección de tarifas, productos contratados o servicios adicionales',
                'criticidad': 'Media'
            },
